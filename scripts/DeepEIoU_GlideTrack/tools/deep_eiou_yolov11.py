...
def make_parser():
    ...
    parser.add_argument('--proximity_thresh', type=float, default=0.3, help='threshold for rejecting low overlap reid matches')
    ...
    #glide args
    parser.add_argument("--glide_weights", default=r"traj_encode_missing_option_mamba_4_60_60_60_dropout_2_3_1_0_1_0_0_x_semb_4.pth", type=str, help="glide weight path")
    parser.add_argument("--glide_label", default=r"_x_semb_4", type=str, help="glide label")
    parser.add_argument('--in_dim', type=int, default=36, help='in dimension')
    parser.add_argument('--num_freqs', type=int, default=4, help='num of frequency banks')
    ...
    for frame_id, img_path in enumerate(files, 1):
        ...
        if len(outputs)>0:
            ...
            for t in online_targets:
                tlwh = t.last_tlwh
                tid = t.track_id
                #print(frame_id, tid, tlwh, t.score)
